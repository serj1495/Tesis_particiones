...
que resulta \'util en el estudio de las
...
una cuarta familia de obstrucciones mínimas al tomar todos los
posibles complementos parciales de la gráfica $F_7$ (Figura
\ref{obsts_2polares_05}) que también es una obstrucción mínima
de las gráficas 2-polares. La gráfica $F_7$ se puede construir agregando un $K_2$ a una de las obstrucciones
