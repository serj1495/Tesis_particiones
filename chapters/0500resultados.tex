...
amplio estudio de la clase de cográficas que aceptan una partición en dos
...
\section{Términos y algoritmos generales}
    En esta sección se presenta un conjunto de conceptos y algoritmos cuya
    utilidad, aunque acotada a las cográficas, no se limita a las clase de
    cográficas que conforman el tema principal de nuestra tesis. El resultado
    principal de la sección es un algoritmo de tiempo lineal que es capaz de
